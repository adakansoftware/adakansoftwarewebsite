  ...
  return (
    <>
      <PageHeader
        ...
        description="Each project connects brand storytelling, user experience, and technical execution around one clear objective."
      ...
      <section className="relative pb-32">
        <div className="section-shell grid gap-8 md:grid-cols-2">
          {projects.map((project) => (
            <article key={project.title} id={project.href.split("#")[1]} className="group rounded-2xl border border-border/50 bg-card/25 p-6 backdrop-blur-md premium-border">
              <div
        ...
        <div className="section-shell mt-12">
          <Link href="/en/contact" className="inline-flex items-center gap-2 rounded-full border border-border/50 px-6 py-3 text-sm text-muted-foreground transition-colors hover:border-primary/50 hover:text-foreground">
