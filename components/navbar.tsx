  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed top-0 right-0 left-0 z-[70] transition-[background-color,border-color,box-shadow,backdrop-filter] duration-500 ${
          ...
          <MagneticButton strength={0.15}>
            <Link href={withLocale("/", activeLocale)} className="flex items-center" aria-label={labels.homeLabel}>
              <Image
                ...
                height={84}
                priority
                className="h-10 w-auto drop-shadow-[0_0_18px_rgba(45,212,191,0.22)] md:h-11"
              />
            </Link>
          </MagneticButton>
